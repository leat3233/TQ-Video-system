<?php 
    ...
    $where = "";
    $count = $db->get_count('indexapp',$where,'id'); 
    ...
    $apps = $db->query('indexapp','',$where,'id desc',"{$page},".PAGESIZE);
    $data = '';
    foreach ($apps as $app){
		$data .= "<tr>
                    ...
                    <td>
                     <a class='btn btn3 del' rel='indexapp'  id='{$app['id']}' href='javascript:;'><i class='fa fa-trash'></i>删除</a>
                    	<a class='btn btn2' rel='updateapps' appid='{$app['id']}' href='javascript:;'><i class='fa fa-edit'></i>更新</a>
            		</td>
                </tr>";
    }
